...
<ul>
  ...
  <li>Права доступа</li>
  <li>API</li>
  <li>Telegram Bot (<i>Инструкция будет ниже</i>)</li>
...
<br>
<h2>Запуск телеграм бота в синхронизации с сайтом</h2>
<i>Далее инструкция представлена из расчета, что пользователь уже знает, как создать пустого бота в телеграм, получить token</i>
