...
<p>Неавторизованные пользователи получают доступ только на чтение, а вот авторизованные могут вполнять действия в заваисимости от прав доступа. На проекте доступны 3 виде аутентификации: базовый на основе пароля и логина, сессии и токен аутентификация</p>
